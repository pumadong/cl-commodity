...
(64,'商品新增','/controller/commodity/add.do','',51,'s-2-1',1,'c','system',NOW(),'system',NOW()),
(65,'商品管理','/controller/commodity/list.do','',51,'s-2-2',2,'c','system',NOW(),'system',NOW()),
(66,'商品日志','/controller/commodity/log.do','',51,'s-2-3',3,'c','system',NOW(),'system',NOW()),
(67,'价格管理','/controller/price/list.do','',52,'s-3-1',1,'c','system',NOW(),'system',NOW()),
...
(70,'图片管理','/controller/picture/list.do','',53,'s-4-2',2,'c','system',NOW(),'system',NOW())
;